...
@interface DesignPhotoDetailViewController ()

@end

@implementation DesignPhotoDetailViewController
...
- (void)viewDidLoad {
    ...
    if([Common info].deeplink_url != nil) {
        if ( [[Common info].deeplink_url rangeOfString:@"_mobile_designphoto"].location != NSNotFound
    ...
    if([_selected_theme.theme2_id isEqualToString:@"miniwallet"] || [_selected_theme.theme2_id isEqualToString:@"division"]){
