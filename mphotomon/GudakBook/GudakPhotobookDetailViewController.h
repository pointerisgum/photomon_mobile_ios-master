//
//  GudakPhotobookDetailViewController.h
//  PHOTOMON
//
...
@interface GudakPhotobookDetailViewController : UIViewController
...
@property (strong, nonatomic) IBOutlet UIButton *covertype;
