//
//  GoodsPosterDetailViewController.m
//  PHOTOMON
//
...
#import "GoodsPosterDetailViewController.h"
#import "Analysis.h"
...
@interface GoodsPosterDetailViewController ()

@property NSInteger sel_coating_idx;

@end

@implementation GoodsPosterDetailViewController

- (void)viewDidLoad {

    [super viewDidLoad];
    [Analysis log:@"PosterDetail"];
...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [Analysis firAnalyticsWithScreenName:@"PosterDetail" ScreenClass:[self.classForCoder description]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_selected_theme != nil) {
        ...
        _default_components.text = _book_info.cm;
