//
//  DdukddakLandscapeWebViewController.m
//  PHOTOMON
//
...
@interface DdukddakLandscapeWebViewController () <NSURLConnectionDelegate, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler>

@end

@implementation DdukddakLandscapeWebViewController
...
- (void)viewWillAppear:(BOOL)animated {
	...
	[self loadURL:_url];
//	[self loadURL:@"http://www.photomon.com/order/previewAutoEdit_190911.asp?bidx=354517"];
}
