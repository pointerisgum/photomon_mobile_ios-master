//
//  GiftPostcardEditViewController.h
//  PHOTOMON
//
...
@interface GiftPostcardEditViewController : UIViewController <PhotoCropViewControllerDelegate, PhotobookDelegate, SelectPhotoDelegate, MBProgressHUDDelegate, GuideDelegate>
