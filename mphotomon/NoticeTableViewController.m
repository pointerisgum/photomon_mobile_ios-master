...
- (void)viewDidLoad {
    ...
    [[PhotomonInfo sharedInfo] loadNoticeList];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [PhotomonInfo sharedInfo].noticeList.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NoticeItem *item = [PhotomonInfo sharedInfo].noticeList[indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    NoticeItemViewController *vc = [segue destinationViewController];
    if (item && vc) {
        vc.notice_idx = item.idx;
    }
