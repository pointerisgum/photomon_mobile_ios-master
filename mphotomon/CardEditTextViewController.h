...
@protocol CardEditTextDelegate <NSObject>
//@optional
- (void)editTextDone:(NSString *)oriText withFmtText:(NSString* )fmtText withAlignment:(int)alignment;
@end

@interface CardEditTextViewController : UIViewController <UIGestureRecognizerDelegate, UITextFieldDelegate, UITextViewDelegate>
...
@property (strong, nonatomic) id<CardEditTextDelegate> delegate;
