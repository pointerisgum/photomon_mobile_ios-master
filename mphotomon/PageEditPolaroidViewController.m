//
//  PageEditPolaroidViewController.m
//  PHOTOMON
//
...
@interface PageEditPolaroidViewController ()

@end

@implementation PageEditPolaroidViewController
...
- (void)updateLayouts {
	...
	[[Common info].layout_pool.layouts removeAllObjects];

	[[Common info].layout_pool loadLayouts:[Common info].photobook.ProductSize Theme:@"" ProductType:PRODUCT_POLAROID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    UICollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"PageEditPolaroidCell" forIndexPath:indexPath];
