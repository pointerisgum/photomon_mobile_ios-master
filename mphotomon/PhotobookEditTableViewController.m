//
//  PhotobookEditTableViewController.m
//  PHOTOMON
//
...
@interface PhotobookEditTableViewController ()

@end

@implementation PhotobookEditTableViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CGFloat cell_h = ((cell_w * page_rect.size.height) / page_rect.size.width) + 15*2;
