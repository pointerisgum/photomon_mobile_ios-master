//
//  PolaroidEditTextViewController.h
//  photoprint
//
...
@protocol PolaroidEditTextDelegate <NSObject>
//@optional
- (void)editTextDone:(NSString *)oriText withFmtText:(NSString* )fmtText withAlignment:(int)alignment;
@end

@interface PolaroidEditTextViewController : UIViewController <UIGestureRecognizerDelegate, UITextFieldDelegate, UITextViewDelegate>
...
@property (strong, nonatomic) id<PolaroidEditTextDelegate> delegate;
