//
//  DesignPhotoEditViewController.h
//  PHOTOMON
//
...
@interface SingleCardEditViewController : UIViewController <PhotoCropViewControllerDelegate, PhotobookDelegate, SelectPhotoDelegate, MBProgressHUDDelegate, GuideDelegate>{
    
    NSMutableArray *isFronts;
...
@property (weak, nonatomic) IBOutlet UILabel *changeDesignEditBG;
