...
- (UIImage*) applyBlendFilter:(FilterBlendCallback)filter other:(UIImage*)other context:(void*)context
{
	...
	int otherLength = (int)CFDataGetLength(m_OtherDataRef);
...
- (UIImage*) levels:(NSInteger)black mid:(NSInteger)mid white:(NSInteger)white
{
	LevelsOptions l;
	l.midPoint = (int)mid;
	l.whitePoint = (int)white;
	l.blackPoint = (int)black;
...
- (UIImage*) applyConvolve:(NSArray*)kernel
{
    ...
    int outputLength = (int)CFDataGetLength(m_OutDataRef);
	...
	int kh = (int)([kernel count] / 2.0f);
	int kw = (int)([[kernel objectAtIndex:0] count] / 2.0f);
	int i = 0, j = 0, n = 0, m = 0;
